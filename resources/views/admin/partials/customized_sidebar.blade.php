            ...
            <div class="dt-customizer__body-inner">
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-theme="light">
                                    <img src="{{asset('backend/assets/images/customizer-icons/theme-light.png')}}" alt="Light">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-theme="semidark">
                                    <img src="{{asset('backend/assets/images/customizer-icons/theme-normal.png')}}" alt="Normal">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-theme="dark">
                                    <img src="{{asset('backend/assets/images/customizer-icons/theme-dark.png')}}" alt="Dark">
                                </a>
                        ...
                        <li class="dt-list__item d-none d-lg-block">
                            <div class="choose-option">
                                <a href="javascript:void(0)" id="toggle-fixed-sidebar" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/fix-sidebar.png')}}" alt="Fix Sidebar">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" id="toggle-fixed-header" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/fix-header.png')}}" alt="Fix Header">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" id="sl-option1" data-value="folded">
                                    <img src="{{asset('backend/assets/images/customizer-icons/folded.png')}}" alt="Folded">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" id="sl-option2" data-value="default">
                                    <img src="{{asset('backend/assets/images/customizer-icons/default.png')}}" alt="Default">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" id="sl-option3" data-value="drawer">
                                    <img src="{{asset('backend/assets/images/customizer-icons/drawer.png')}}" alt="Drawer">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-layout="framed">
                                    <img src="{{asset('backend/assets/images/customizer-icons/framed.png')}}" alt="Framed">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-layout="full-width">
                                    <img src="{{asset('backend/assets/images/customizer-icons/full-width.png')}}" alt="Full Width">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="javascript:void(0)" class="choose-option__icon" data-layout="boxed">
                                    <img src="{{asset('backend/assets/images/customizer-icons/boxed.png')}}" alt="Boxed">
                                </a>
                ...
                <section>
                    ...
                    <ul class="dt-list">
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-default.png')}}" alt="Layout Default">
                                </a>
                                <span class="choose-option__name">Default</span>
                            </div>
                        </li>
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../saas/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-saas.png')}}" alt="Layout SAAS">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../listing/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-listing.png')}}" alt="Layout listing">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../intranet/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-intranet.png')}}" alt="Layout Intranet">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../back-office/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-back-office.png')}}" alt="Layout Back Office">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../back-office-mini/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-back-office-mini.png')}}"
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../modern/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-modern.png')}}" alt="Layout Modern">
                                </a>
                        ...
                        <li class="dt-list__item">
                            <div class="choose-option">
                                <a href="../crm/index.html" target="_blank" class="choose-option__icon">
                                    <img src="{{asset('backend/assets/images/customizer-icons/layout-crm.png')}}" alt="Layout CRM">
                                </a>
