        ...
        <div class="row dt-masonry">
            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <ol class="mb-0 breadcrumb">
                    ...
                    <li class="active breadcrumb-item"><a href="{{route('members.create')}}">Create</a> </li>
                </ol>
                <!-- /breadcrumbs -->
                ...
                <div class="dt-card">
                    ...
                    <div class="dt-card__header">
                        ...
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Add Member</h3>
                        </div>
                        <!-- /card heading -->
                    ...
                    <div class="dt-card__body">
                        ...
                        <!-- Form -->
                        <form id="form" method="post" action="{{route('members.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="team_category" id="team_category" class="form-control js-example-basic-single" >
                                            ...
                                            @foreach($teamCategories as $category)
                                                ...
                                                <option value="{{$category->id}}"  {{ old('team_category') == $category->id? 'selected' : '' }}> {{$category->name}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="designation" id="designation" class="form-control js-example-basic-single" >
                                            ...
                                            @foreach($designations as $desig)
                                                ...
                                                <option value="{{$desig->id}}"  {{ old('designation') == $desig->id? 'selected' : '' }}> {{$desig->title}}</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input id="facebook" type="url" value="{{old('facebook')}}" class="form-control" name="facebook"
