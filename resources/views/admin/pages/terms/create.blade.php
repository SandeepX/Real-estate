        ...
        <div class="row dt-masonry">
            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <ol class="mb-0 breadcrumb">
                    ...
                    <li class="active breadcrumb-item"><a href="{{route('conditions.create')}}">Add</a> </li>
                </ol>
                <!-- /breadcrumbs -->
                ...
                <div class="dt-card">
                    ...
                    <div class="dt-card__header">
                        ...
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Add Terms & Conditions</h3>
                        </div>
                        <!-- /card heading -->
                    ...
                    <div class="dt-card__body">
                        ...
                        <!-- Form -->
                        <form id="form" method="post" action="{{route('conditions.store')}}" >
...
@push('scripts')
    ...
    @include('admin.pages.terms.terms-scripts')
