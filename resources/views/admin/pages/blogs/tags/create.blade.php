        ...
        <div class="row dt-masonry">
            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <ol class="mb-0 breadcrumb">
                    ...
                    <li class="active breadcrumb-item"><a href="{{route('blogs-tag.create')}}">Create</a> </li>
                </ol>
                <!-- /breadcrumbs -->
                ...
                <div class="dt-card">
                    ...
                    <div class="dt-card__header">
                        ...
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Add Tag</h3>
                        </div>
                        <!-- /card heading -->
                    ...
                    <div class="dt-card__body">
                        ...
                        <!-- Form -->
                        <form id="form" method="post" action="{{route('blogs-tag.store')}}">
