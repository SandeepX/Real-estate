        ...
        <div class="row dt-masonry">
            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <ol class="mb-0 breadcrumb">
                    ...
                    <li class="active breadcrumb-item"><a href="{{route('blogs.create')}}">Create</a> </li>
                </ol>
                <!-- /breadcrumbs -->
                ...
                <div class="dt-card">
                    ...
                    <div class="dt-card__header">
                        ...
                        <div class="dt-card__heading">
                            <h3 class="dt-card__title">Add Blog</h3>
                        </div>
                        <!-- /card heading -->
                    ...
                    <div class="dt-card__body">
                        ...
                        <!-- Form -->
                        <form id="form" method="post" action="{{route('blogs.store')}}" enctype="multipart/form-data">
                        ...
                        {{ csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="blog_category" id="blog_category" class="form-control js-example-basic-single" >
                                            ...
                                            @foreach($blogCategories as $category)
                                                ...
                                                <option value="{{$category->id}}"  {{ old('blog_category') == $category->id? 'selected' : '' }}> {{$category->title}}</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="summernote" name="description" rows="3" class="form-control">{{ old('description') }}</textarea>
                            </div>
                            <!-- /form group -->
                            ...
                            <div class="form-group">
                                ...
                                <select name="blog_tags[]" id="blog_tags" class="form-control js-example-basic-multiple" multiple >
                                    ...
                                    @foreach($tags as $tag)
                                        ...
                                        <option value="{{$tag->id}}"  @if(is_array(old('blog_tags')) && in_array($tag->id,old('blog_tags'))) selected @endif>
                                            {{$tag->title}}
                                        </option>
