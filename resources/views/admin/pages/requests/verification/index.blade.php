...
@section('content')
    ...
    <div class="dt-content">
        ...
        <div class="row dt-masonry">
            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <ol class="mb-0 breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.request.verification')}}">Verification Requests</a></li>
                </ol>
                <!-- /breadcrumbs -->
        ...
        <div class="dt-page__header mt-3">
            <h1 class="dt-page__title">All Verification Requests</h1>
        </div>
        <!-- /page header -->
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            <div>
                                                ...
                                                <a href="{{route('admin.request.verification.single',$property->id)}}" data-id="{{$property->id}}" type="button" class="parameter-alert edit-button btn btn-xs btn-success mr-2 mb-2">
                                                   Verify
                                                </a>
