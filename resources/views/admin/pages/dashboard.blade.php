                        ...
                        <div class="dt-card__tools">
                            ...
                            <div class="dropdown d-inline-block">
                                <a class="dropdown-toggle d-inline-block f-12 py-1 px-2 py-1 border rounded"
                                   href="dashboard-real-estate.html#"
                    ...
                    <div class="dt-card__header mb-5">
                        ...
                        <div class="dt-card__tools">
                            <ul class="nav nav-sm nav-underline nav-underline-none" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="dashboard-real-estate.html#premium" role="tab"
                                       aria-controls="premium"
                                       aria-selected="true">Premium</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="dashboard-real-estate.html#full" role="tab"
                                       aria-controls="full"
                                ...
                                <div class="dt-widget dt-widget-sm dt-widget-hover">
                                    ...
                                    <div class="dt-widget__item">
                                        ...
                                        <div class="dt-widget__img">
                                            <img class="img-fluid max-w-90" src="assets/images/logo/4.jpg"
                                                 alt="Logo">
                                        </div>
                                        <!-- /widget image -->
                                        ...
                                        <div class="dt-widget__info text-truncate">
                                            <div class="dt-widget__title text-truncate">
                                                <a href="dashboard-real-estate.html#">Goyal and Co.</a>
                                            </div>
                                            <!-- List -->
                                    ...
                                    <div class="dt-widget__item">
                                        ...
                                        <!-- Widget Image -->
                                        <div class="dt-widget__img">
                                            <img class="img-fluid max-w-90" src="assets/images/logo/5.jpg"
                                                 alt="Logo">
                                        </div>
                                        <!-- /widget image -->
                                        ...
                                        <div class="dt-widget__info text-truncate">
                                            <div class="dt-widget__title text-truncate">
                                                <a href="dashboard-real-estate.html#">Savaliya Builders</a>
                                            </div>
                                            <!-- List -->
                                            <ul class="dt-list dt-list-bordered dt-widget__subtitle text-light-gray dt-list-cm-0 flex-nowrap">
                                                <!-- List Item -->
                                    ...
                                    <div class="dt-widget__item">
                                        ...
                                        <!-- Widget Image -->
                                        <div class="dt-widget__img">
                                            <img class="img-fluid max-w-90" src="assets/images/logo/9.jpg"
                                                 alt="Logo">
                                        </div>
                                        <!-- /widget image -->
                                        ...
                                        <div class="dt-widget__info text-truncate">
                                            <div class="dt-widget__title text-truncate">
                                                <a href="dashboard-real-estate.html#">Galaxy Group Pvt. Ltd</a>
                                            </div>
                                            <!-- List -->
                                            <ul class="dt-list dt-list-bordered dt-widget__subtitle text-light-gray dt-list-cm-0 flex-nowrap">
                                                <!-- List Item -->
                                    ...
                                    <div class="dt-widget__item">
                                        ...
                                        <!-- Widget Image -->
                                        <div class="dt-widget__img">
                                            <img class="img-fluid max-w-90" src="assets/images/logo/1.jpg"
                                                 alt="Logo">
                                        </div>
                                        <!-- /widget image -->
                                        ...
                                        <div class="dt-widget__info text-truncate">
                                            <div class="dt-widget__title text-truncate">
                                                <a href="dashboard-real-estate.html#">Savvy Infrastructure</a>
                                            </div>
                                            <!-- List -->
                                            <ul class="dt-list dt-list-bordered dt-widget__subtitle text-light-gray dt-list-cm-0 flex-nowrap">
                                                <!-- List Item -->
                                    ...
                                    <div class="dt-widget__item">
                                        ...
                                        <!-- Widget Image -->
                                        <div class="dt-widget__img">
                                            <img class="img-fluid max-w-90" src="assets/images/logo/7.jpg"
                                                 alt="Logo">
                                        </div>
                                        <!-- /widget image -->
                                        ...
                                        <div class="dt-widget__info text-truncate">
                                            <div class="dt-widget__title text-truncate">
                                                <a href="dashboard-real-estate.html#">Sparsh Procon Pvt. Ltd.</a></div>
                                            <!-- List -->
                                            <ul class="dt-list dt-list-bordered dt-widget__subtitle text-light-gray dt-list-cm-0 flex-nowrap">
                                                <!-- List Item -->
                                                <li class="dt-list__item text-truncate">
                        ...
                        <div class="col-xl-6">
                            ...
                            <div class="dt-card__header mb-0">
                                ...
                                <div class="dt-card__tools">
                                    <ul class="nav nav-sm nav-underline nav-underline-none" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="dashboard-real-estate.html#city"
                                               role="tab" aria-controls="city"
                                               aria-selected="true">City</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="dashboard-real-estate.html#state" role="tab"
                                               aria-controls="state"
                                               aria-selected="true">State</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-toggle="tab" href="dashboard-real-estate.html#area" role="tab"
                                               aria-controls="area"
                    ...
                    <div class="dt-card__body p-0 max-h-400 ps-custom-scrollbar">
                        ...
                        <div class="dt-widget dt-widget-hover-bg text-light-gray">
                            ...
                            <div class="dt-widget__item">
                                ...
                                <!-- Widget Image -->
                                <div class="dt-widget__img">
                                    <img class="img-fluid max-w-105" src="assets/images/logo/4.jpg"
                                         alt="Logo">
                                </div>
                                <!-- /widget image -->
                            ...
                            <div class="dt-widget__item">
                                ...
                                <!-- Widget Image -->
                                <div class="dt-widget__img">
                                    <img class="img-fluid max-w-105" src="assets/images/logo/5.jpg"
                                         alt="Logo">
                                </div>
                                <!-- /widget image -->
                                ...
                                <div class="dt-widget__info text-truncate">
                                    <div class="dt-widget__title text-truncate">
                                        <a href="dashboard-real-estate.html#">Swati Procon</a>
                            ...
                            <div class="dt-widget__item">
                                ...
                                <!-- Widget Image -->
                                <div class="dt-widget__img">
                                    <img class="img-fluid max-w-105" src="assets/images/logo/9.jpg"
                                         alt="Logo">
                                </div>
                                <!-- /widget image -->
                                ...
                                <div class="dt-widget__info text-truncate">
                                    <div class="dt-widget__title text-truncate">
                                        <a href="dashboard-real-estate.html#">Sparsh Procon Pvt. Ltd.</a>
                                        <span class="badge badge-sm badge-pill badge-success d-none d-sm-inline-block">Basic</span>
                                    </div>
                                    <p class="dt-widget__subtitle text-truncate">
                                        missouri.gerhold@example.com</p>
                            ...
                            <div class="dt-widget__item">
                                ...
                                <!-- Widget Image -->
                                <div class="dt-widget__img">
                                    <img class="img-fluid max-w-105" src="assets/images/logo/1.jpg"
                                         alt="Logo">
                                </div>
                                <!-- /widget image -->
                                ...
                                <div class="dt-widget__info text-truncate">
                                    <div class="dt-widget__title text-truncate">
                                        <a href="dashboard-real-estate.html#">SS Group</a>
                                        <span class="badge badge-sm badge-pill badge-success d-none d-sm-inline-block">Basic</span>
                                    </div>
                                    <p class="dt-widget__subtitle text-truncate">
                                        missouri.gerhold@example.com</p>
                            ...
                            <div class="dt-widget__item">
                                ...
                                <!-- Widget Image -->
                                <div class="dt-widget__img">
                                    <img class="img-fluid max-w-105" src="assets/images/logo/7.jpg"
                                         alt="Logo">
                                </div>
                                <!-- /widget image -->
                                ...
                                <div class="dt-widget__info text-truncate">
                                    <div class="dt-widget__title text-truncate">
                                        <a href="dashboard-real-estate.html#">Swetalee Developers</a>
                                        <span
                    ...
                    <div class="dt-card__body p-0 max-h-400 ps-custom-scrollbar">
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    ...
                                    <img class="dt-avatar size-35"
                                         src="assets/images/user-avatar/mathew.jpg" alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35"
                                         src="assets/images/user-avatar/kemroon-white.jpg" alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35"
                                         src="assets/images/user-avatar/jeson-born.jpg" alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35"
                                         src="assets/images/user-avatar/steve-smith.jpg" alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35" src="assets/images/user-avatar/man-3.jpg"
                                         alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35"
                                         src="assets/images/user-avatar/garry-sobars.jpg" alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                      ...
                      <span
                            ...
                            <div class="dt-widget__item">
                                ...
                                <div class="dt-widget__img">
                                    <!-- Avatar -->
                                    <img class="dt-avatar size-35" src="assets/images/user-avatar/amay.jpg"
                                         alt="User">
                                    <!-- /avatar -->
                                </div>
                                <!-- /widget image -->
                                            ...
                                            <li class="dt-list__item">
                                                <div class="dropdown">
                                                    <a class="dropdown-toggle no-arrow text-light-gray"
                                                       href="dashboard-real-estate.html#" data-toggle="dropdown"
                                                       aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dt-card dt-contact-card">
                    ...
                    <div class="dt-card__header mb-3 header-sm-inline">
                        ...
                        <div class="dt-card__tools">
                            <ul class="nav nav-sm nav-underline nav-underline-none" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="dashboard-real-estate.html#marketing"
                                       role="tab"
                                       aria-controls="marketing"
                                       aria-selected="true">Marketing</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="dashboard-real-estate.html#account" role="tab"
                                       aria-controls="account"
                                       aria-selected="true">Account</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" data-toggle="tab" href="dashboard-real-estate.html#development" role="tab"
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="dt-contact-info-short">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                <!-- Avatar -->
                                                <img class="dt-avatar"
                                                     src="assets/images/user-avatar/man-3.jpg"
                                                     alt="Harriet Boone">
                                                <!-- /avatar -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="dt-contact-info-short">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                <!-- Avatar -->
                                                <img class="dt-avatar"
                                                     src="assets/images/user-avatar/kadir-m.jpg"
                                                     alt="Violet Jimenez">
                                                <!-- /avatar -->
                                    ...
                                    <div class="col-md-4 col-sm-6 col-12">
                                        ...
                                        <div class="dt-contact-info-short">
                                            ...
                                            <div class="dt-avatar-wrapper">
                                                <!-- Avatar -->
                                                <img class="dt-avatar"
                                                     src="assets/images/user-avatar/daisy.jpg"
                                                     alt="Johanna Terry">
                                                <!-- /avatar -->
                    ...
                    <div class="dt-card__header">
                        ...
                        <div class="dt-card__tools align-self-start mt-n3 mr-n2">
                            ...
                            <div class="dropdown">
                                ...
                                <!-- Dropdown Button -->
                                <a href="dashboard-real-estate.html#" class="dropdown-toggle no-arrow text-white"
