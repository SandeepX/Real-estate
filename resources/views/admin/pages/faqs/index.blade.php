            ...
            <div class="col-md-12 dt-masonry__item">
                ...
                <div class="dt-card">
                    ...
                    <div class="dt-card__body">
                        ...
                        <a class="btn btn-primary pull-right" href="{{route('faqs.create')}}" style="margin-bottom: 10px !important;" width="100%">
                            ...
                            <table id="data-table" class="table table-striped table-bordered table-hover">
                                ...
                                @forelse($faqs as $faq)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            <i class="fa {{$faq->status? 'fa-check' : 'fa-ban'}}" aria-hidden="true"></i>
                                        </td>

                                        <td style="">

                                            <div>
                                                <a  href="{{route('faqs.edit',$faq->id)}}"  type="button" class="edit-button btn btn-xs btn-warning mr-2 mb-2">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i>
                                                </a>
                                                <form class="confirm_delete{{$faq->id}}"  action="{{route('faqs.destroy',$faq->id)}}" method="POST">
                                                    <input type="hidden" name="_method" value="DELETE">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                    <button type="submit" data-id="{{$faq->id}}" class="btn btn-xs btn-danger mr-2 mb-2 parameter-alert">
