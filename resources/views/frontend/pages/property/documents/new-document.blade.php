<form id="document_form" method="post" action="{{route('user.property.files.store',$property->id)}}" enctype="multipart/form-data">
    ...
    <div class="row">
            ...
            <div id="db_documents">
                @if(isset($propertyDocument->lal_purja))
                    <div class="db_docs">
                        ...
                        <a>
                            <i data-url="{{route('user.property.files.destroy',[$propertyDocument->id,'lal_purja'])}}" class='remove-db-doc fa fa-times' ></i>
            ...
            <div id="db_documents">
                @if(isset($propertyDocument->ghar_naksa))
                    <div class="db_docs">
                        ...
                        <a>
                            <i data-url="{{route('user.property.files.destroy',[$propertyDocument->id,'ghar_naksa'])}}" class='remove-db-doc fa fa-times' ></i>
            ...
            <div id="db_documents">
                @if(isset($propertyDocument->trace_naksa))
                    <div class="db_docs">
                        ...
                        <a>
                            <i data-url="{{route('user.property.files.destroy',[$propertyDocument->id,'trace_naksa'])}}" class='remove-db-doc fa fa-times' ></i>
            ...
            <div id="db_documents">
                @if(isset($propertyDocument->blueprint))
                    <div class="db_docs">
                        ...
                        <a>
                            <i data-url="{{route('user.property.files.destroy',$propertyDocument->id)}}" class='remove-db-doc fa fa-times' ></i>
        ...
        <div class="col-lg-12">
            ...
            <div class="send-btn">
                <button type="submit" class="btn btn-basic-info">Upload Documents</button>
            </div>
        </div>
    </div>
</form>