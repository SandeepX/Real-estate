    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-9">
                <h3 class="featured-prop-title">New Properties</h3>
                <div class="bod-bot-div"></div>
            </div>
            <div class="col-lg-3 col-md-3">
                <a href="{{route('fe.newProperty')}}" class="btn view-more-btn-top">View More List</a>
            </div>
            <div class="col-lg-12">
                <div class="owl-trend owl-carousel partner-nav">
                    @foreach($newProperties as $property)
                        <div class="property-box-trend">
                            <div class="property-photo property-fixed-height">
