<script>
   ...
   var customInfoWindow;
    ...
    var propertyMarkers = {!!json_encode($allProperties) !!};
    ...
    function initMap() {
        ...
        for( i = 0; i < markers.length; i++ ) {
            ...
            let displayContent = '<div class="info_content">' +
                ...
                '<h6 class="map-img-title"><a class="lalita" href='+singleRoute+'>'+ markers[i]['title']+'</a></h6>' +
                ...
                '<p class="map-category-p"><a href='+categoryRoute+' class="map-category lalita">'+markers[i]['category']['name']+'</a>' +
                '<a href='+subCategoryRoute+' class="map-category lalita">'+markers[i]['sub_category']['name']+'</a>' +
                '</p></div>';
            ...
            let newImageUrl = "{{asset('frontend/img/')}}"+'/'+markers[i]['sub_category']['slug']+'.png';
...
<script>
    ...
    $(document).on('click', '.lalita', function(e) {
